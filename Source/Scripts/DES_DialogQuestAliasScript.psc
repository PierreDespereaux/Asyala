Scriptname DES_DialogQuestAliasScript extends ReferenceAlias  
...
Event OnUpdateGameTime()
     ...
     If Self.GetActorRef().GetActorValue("WaitingforPlayer") == 1
          ...
          (GetOwningQuest() as  DES_AsyalaFollowerFramework).DismissFollower(0,0)
     EndIf
EndEvent
...
Event OnUnload()
     ...
     If Self.GetActorReference().GetActorValue("WaitingforPlayer") == 1
          (GetOwningQuest() as  DES_AsyalaFollowerFramework).FollowerWait()
     EndIf
EndEvent
